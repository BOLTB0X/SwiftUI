...
struct PracticeWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = PracticeWidgetAttributes(name: "Me")
    static let contentState = PracticeWidgetAttributes.ContentState(value: 3)
